...
from .views.factory import view_all_factories_paganated, view_factory_detail, view_factory_production, view_campaign_create, view_campaign_active, view_offered_factories_paganated, view_my_factories, view_add_factory, view_factory_components
...
urlpatterns = [
    ...
    path('factory/<int:pk>/components', view_factory_components, name='factory_components'),
