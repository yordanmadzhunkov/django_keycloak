            ...
            if form.is_valid():
                ...
                for year in range(start_year, end_year + 1):
                    for month in range(1, 13):
                        ...
                        row.append(
                            plan.get_working_hours(p)
                            * factory.capacity_in_mw
                            * prices.get_price(p)
                        )
        ...
        if formset.is_valid():
            ...
            for form in formset:
                ...
                try:
                    ...
                    s = objects.filter(month__year=month.year).filter(
        ...
        if plan_formset.is_valid():
            ...
            for form in plan_formset:
                if (
                    ...
                    or plan.start_year != form.cleaned_data["start_year"]
                    or plan.end_year != form.cleaned_data["end_year"]
                ):
                    plan.name = form.cleaned_data["name"]
