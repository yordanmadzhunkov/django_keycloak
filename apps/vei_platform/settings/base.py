...
LOCALE_PATHS = (
    (BASE_DIR / "locale"),
)  # translation files will be created into 'locale' folder from root project folder
...
OPEN_EXCHANGE_RATES_APP_ID = config(
    "OPEN_EXCHANGE_RATES_APP_ID", default="d4d02b6623504e4ca51c588443e960d5"
)
